...
class EntityExtractor {
    ...
    private function extractKeywords(string $text): array {
        ...
        // Remove stop words and get meaningful keywords, optimized for O(1) lookups
        static $stopWords = [
            'is' => true, 'the' => true, 'a' => true, 'an' => true, 'of' => true, 'in' => true, 'to' => true, 'for' => true, 'and' => true, 'or' => true, 'but' => true,
